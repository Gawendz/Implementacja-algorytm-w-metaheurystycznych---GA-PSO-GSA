...
def fitness(individual):
    return eggholder_function(individual)  
...
def genetic_algorithm():
    ...
    run_number = 1
    if os.path.isfile('wyniki_GA_eggholder.csv'):
        with open('wyniki_GA_eggholder.csv', mode='r', newline='', encoding='utf-8') as csv_file:
    ...
    file_exists = os.path.isfile('wyniki_GA_eggholder.csv')
    with open('wyniki_GA_eggholder.csv', mode='a', newline='', encoding='utf-8') as csv_file:
        fieldnames = [
            'Numer próby',
    ...
    print("\nWyniki zostały zapisane do pliku 'wyniki_GA_eggholder.csv'.")
