...
def genetic_algorithm():
    ...
    generation = 0
    max_generations = 1000  #Maksymalna liczba iteracjii
    ...
    run_number = 1
    if os.path.isfile('wyniki_GA_michalewicz.csv'):
        with open('wyniki_GA_michalewicz.csv', mode='r', newline='', encoding='utf-8') as csv_file:
    ...
    file_exists = os.path.isfile('wyniki_GA_michalewicz.csv')
    with open('wyniki_GA-michalewicz.csv', mode='a', newline='', encoding='utf-8') as csv_file:
        fieldnames = [
            'Numer próby',
    ...
    print("\nWyniki zostały zapisane do pliku 'wyniki_GA_michalewicz.csv'.")
